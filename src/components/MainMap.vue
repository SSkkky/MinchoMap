...
const initMap = () => {
    ...
    function addMarker(position, idx, title) {
        var imageSrc = 'https://firebasestorage.googleapis.com/v0/b/choding.appspot.com/o/gom%2Fmarker_40_60.png?alt=media&token=9ef5864c-6783-4725-a569-a70f6537d3dc', // 마커 이미지 url, 스프라이트 이미지를 씁니다
            imageSize = new kakao.maps.Size(40, 60),  // 마커 이미지의 크기
            imgOptions = {
                spriteSize: new kakao.maps.Size(40, 60), // 스프라이트 이미지의 크기
